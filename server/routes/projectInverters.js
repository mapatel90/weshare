...
router.post('/', authenticateToken, async (req, res) => {
  try {
    const { project_id, inverter_id, kilowatt, status, inverter_serial_number, inverter_name, model, version, warranty_expire_date } = req.body;
...
router.put('/:id', authenticateToken, async (req, res) => {
  try {
    const { id } = req.params;
    const { inverter_id, kilowatt, status, inverter_serial_number, inverter_name, model, version, warranty_expire_date } = req.body;
