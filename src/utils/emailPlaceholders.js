...
export const EMAIL_PLACEHOLDERS = [
  ...
  { key: "[phone_number]", label: "Phone Number", description: "Recipient's phone number" },
  ...
  { key: "[project_size]", label: "Project Size", description: "Size of the project in kWp" },
  { key: "[asking_price]", label: "Asking Price", description: "Asking price for the project" },
  { key: "[investor_note]", label: "Investor Note", description: "Note added by the investor" },
