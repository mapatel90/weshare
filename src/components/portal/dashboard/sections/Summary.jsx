		...
		showUpcomingProjects ?
			{
				...
				label: lang?.("dashboard.upcoming_projects", "Upcoming Projects") ?? "Upcoming Projects",
				value: summaryLoading ? "—" : formatNumber(upcomingProjects),
				description: lang?.("dashboard.upcoming_projects_description", "Upcoming projects description") ?? "Upcoming projects description",
				color: "#777b86",
				textColor: "#1f2937",
