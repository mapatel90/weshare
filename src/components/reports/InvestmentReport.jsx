...
const initialInvestmentReportsData = [
    {
        id: 1,
...
const InvestmentReports = () => {
    ...
    const [reportsData, setReportsData] = useState(initialInvestmentReportsData);

    const projects = useMemo(
        () => Array.from(new Set(initialInvestmentReportsData.map(d => d.projectName))),
        []
    );
    const inverters = useMemo(
        () => Array.from(new Set(initialInvestmentReportsData.map(d => d.inverterName))),
        []
    );
