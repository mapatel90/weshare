    ...
    <div className="col-12 col-md-6 col-xl-4 mb-4">
      <div className="bg-white overflow-hidden h-100" style={{ border: '1px solid #e8e8e8', borderRadius: '12px', boxShadow: '0 2px 8px rgba(0,0,0,0.08)' }}>
        ...
        <div className="p-3">
          ...
          <p className="text-muted small mb-1" style={{ fontSize: '12px' }}>{lang('home.exchangeHub.id')} {project.project_code || `SE-${project.id}`}</p>
          <p className="text-muted small mb-3" style={{ fontSize: '12px' }}>
            {lang('home.exchangeHub.offtaker')} {project.offtaker?.company_name || project.offtaker?.contact_person || 'N/A'}
          </p>
          ...
          <div style={{ borderTop: '1px solid #e8e8e8', paddingTop: '12px', marginBottom: '12px' }}>
            <div className="d-flex justify-content-between align-items-center mb-2">
              ...
              <small className="fw-600" style={{ fontSize: '12px', color: '#1a1a2e' }}>{project.lease_term || `7 ${lang('home.exchangeHub.years')}`}</small>
            </div>
            <div className="d-flex justify-content-between align-items-center mb-2">
