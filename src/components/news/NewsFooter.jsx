      ...
      <div className="container">
        <div className="row gy-4">
          ...
          <div className="col-lg-4 col-md-12">
            ...
            <p className="text-white fw-300 fs-18 mb-4">
              {lang ? lang("home.footer.tagline") : "Democratizing Access to Solar Investments."}
              <br />
              {lang ? lang("home.footer.description") : footerData?.site_description || ""}
            </p>
            <div className="social-icons d-flex gap-4">
              ...
              <Link href="#"><Image src="/images/icons/cat.svg" alt="catalog" width={24} height={24} /></Link>
            </div>
          </div>
          ...
          <div className="col-lg-4 col-md-6">
            <div className="linkBox">
              <h6 className="fs-24 text-secondary-color fw-600 mb-40">
                {lang ? lang("home.footer.quickLinks") : "Quick Links"}
              </h6>
              <ul className="list-unstyled text-white quickLinks">
                <li><Link href="#">{lang ? lang("home.footer.home") : "Home"}</Link></li>
                <li><Link href="#">{lang ? lang("home.footer.aboutUs") : "About Us"}</Link></li>
                <li><Link href="#">{lang ? lang("home.footer.exchangeHub") : "Exchange Hub"}</Link></li>
                <li><Link href="#">{lang ? lang("home.footer.howItWorks") : "How It Works"}</Link></li>
                <li><Link href="#">{lang ? lang("home.footer.news") : "News"}</Link></li>
              </ul>
            </div>
          </div>
          ...
          <div className="col-md-6 col-lg-3">
            <div className="contactBox">
              <h6 className="fs-24 text-secondary-color fw-600 mb-40">
                {lang ? lang("home.footer.contactSettings") : "Contact & Settings"}
              </h6>
              <ul className="list-unstyled text-white-50 small mb-4">
                <li className="mb-4 fs-18 fw-300 text-white">
                  ...
                  {footerData?.site_email ? footerData.site_email : "support@wechain.solar"}
                </li>
                <li className="mb-4 fs-18 fw-300 text-white">
                  <span className="me-3">
                    <Image src="/images/icons/phone-w.svg" alt="phone" width={20} height={20} />
                  </span>
                  {footerData?.site_phone ? footerData.site_phone : "+1 (555) 123-4567"}
                </li>
              ...
              <div className="footer-dropdown">
                <label className="fs-18 fw-300 text-secondary-color d-block mb-1">
                  {lang ? lang("home.footer.country") : "Country"}
                </label>
                <select
                  className="form-select form-select-sm"
                  style={{
        ...
        <div className="copyRightSection d-flex flex-sm-column flex-md-row gap-sm-3 gap-5 align-items-center">
          <p className="mb-2 mb-md-0 fs-18 fw-500 text-white">
            {footerData?.site_copyright || "©2025 WeShare Solar Lease Platform"}
          </p>
          <div className="footer-links d-flex gap-3">
            <Link href="#">{lang ? lang("home.footer.privacyPolicy") : "Privacy Policy"}</Link>
            <Link href="#">{lang ? lang("home.footer.termsOfService") : "Terms of Service"}</Link>
          </div>
        </div>
      </div>
    </footer>
