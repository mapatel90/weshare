    ...
    try {
        ...
        const invoiceHTML = `
            <div style="font-family: Arial, sans-serif; padding:20px;">
                ...
                <div><b>Invoice:</b> ${invoice.invoice_prefix || ""}-${invoice.invoice_number || ""}</div>
                ...
                <table style="width:100%; border-collapse: collapse;">
                    <thead>
                        <tr>
                            <th style="border:1px solid #ddd; padding:8px;">Invoice Amount</th>
                    ...
                    <tbody>
                        <tr>
                            <td style="border:1px solid #ddd; padding:8px;">${priceWithCurrency(invoice.total_amount)}</td>
