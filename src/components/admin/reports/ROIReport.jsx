...
const ROIReports = () => {
    ...
    const [reportsData, setReportsData] = useState(initialROIReportsData);

    const projects = useMemo(
        () => Array.from(new Set(initialROIReportsData.map(d => d.projectName))),
        []
    );
    const inverters = useMemo(
        () => Array.from(new Set(initialROIReportsData.map(d => d.inverterName))),
        []
    );
