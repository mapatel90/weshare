...
const initialConjunctionReportsData = [
    {
        id: 1,
...
const ConjunctionReports = () => {
    ...
    const [reportsData, setReportsData] = useState(initialConjunctionReportsData);

    const projects = useMemo(
        () => Array.from(new Set(initialConjunctionReportsData.map(d => d.projectName))),
        []
    );
    const inverters = useMemo(
        () => Array.from(new Set(initialConjunctionReportsData.map(d => d.inverterName))),
        []
    );
