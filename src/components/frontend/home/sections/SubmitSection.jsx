          ...
          <div className="row mx-0">
            ...
            <div className="col-12 col-md-6" data-aos="fade-left">
              <div className="contentBox me-2">
                ...
                <button className="btn btn-primary-custom mt-0"  style={{ backgroundColor: "#F6A623", borderColor: "#F6A623" }} onClick={() => router.push('/frontend/lease_request')}>{lang('home.submit.button')}</button>
              </div>
            </div>
          </div>
        </div>
