...
export default function GetInTouchHelpSection() {
  ...
  return (
    <div className="col-lg-4 col-md-4 col-sm-12 help-col">
      {(helpData?.site_email || helpData?.site_phone) && (
          ...
          {helpData?.site_email && (
            <div className="help-item my-1">
              <span className="icon d-inline-flex align-items-center justify-content-center">
                <a href={`mailto:${helpData?.site_email}`} target="_blank" rel="noopener noreferrer">
                  <svg
              ...
              <p className="sub-text mt-2"><a href={`mailto:${helpData?.site_email}`} className="text-black" target="_blank" rel="noopener noreferrer">{helpData?.site_email ? helpData.site_email : ""}</a></p>
            </div>
          )}
          {helpData?.site_phone && (
            <>
              ...
              <div className="help-item my-1">
                <span className="icon d-inline-flex align-items-center justify-content-center">
                  <a href={`tel:${helpData?.site_phone}`} target="_blank" rel="noopener noreferrer">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="38"
                      height="38"
                ...
                <p className="sub-text mt-2"><a href={`tel:${helpData?.site_phone}`} className="text-black" target="_blank" rel="noopener noreferrer">{helpData?.site_phone ? helpData.site_phone : ""}</a></p>
              </div>
            </>
          )}
        </div>
