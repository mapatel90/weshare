      ...
      >
        <div className="solar-card-with-image">
          ...
          <div className="card-image-container">
            ...
            {/* Reliability Badge */}
            <div
              className={`upcoming-badge ${badge.class}`}
              style={{ backgroundColor: "#FFF3DF", margin: "2%" }}
            >
          ...
          <div className="card-content-with-image">
            ...
            <div className="details-row-image">
              <div className="detail-item">
                <span className="label">
                  {lang("home.exchangeHub.paybackPeriod") || "Payback Period"}
                </span>
            ...
            <p className="note-text">
              {lang("home.exchangeHub.assumptionNote") ||
                "Note: This is an Assumption data*"}
            </p>
            ...
            <div className="buttons-image">
              ...
              <button
                ...
                onMouseEnter={(e) => {
                  e.currentTarget.style.background = "#102c41";
                  e.currentTarget.style.color = "#fff";
                  e.currentTarget.style.borderColor = "#102c41";
                }}
                onMouseLeave={(e) => {
                  e.currentTarget.style.background = "#fff";
                  e.currentTarget.style.color = "#102c41";
                  e.currentTarget.style.borderColor = "#102c41";
                }}
              >
                <svg
    ...
    >
      <div className="solar-card">
        ...
        <div className="card-header">
          ...
          >
            {project?.project_name || "Solar Project"}
          </h3>
